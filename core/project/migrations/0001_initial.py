# Generated by Django 5.2.7 on 2025-11-16 14:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'فعال'), ('in_progress', 'در حال اجرا'), ('under_review', 'در حال بررسی'), ('awaiting_approval', 'منتظر تأیید'), ('completed', 'تمام\u200cشده'), ('suspended', 'معلق'), ('cancelled', 'لغو شده')], default='active', help_text='وضعیت فعلی پروژه', max_length=20, verbose_name='وضعیت پروژه')),
                ...
                ('user', models.ForeignKey(blank=True, db_constraint=False, limit_choices_to={'is_staff': False}, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='کاربر')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(limit_choices_to={'is_staff': False}, on_delete=django.db.models.deletion.CASCADE, related_name='projects', to=settings.AUTH_USER_MODEL, verbose_name='کاربر')),
            ],
            options={
