...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('project', '0002_historicalproject_vat_percentage_and_more'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discipline', models.CharField(choices=[('AB', 'ابنیه'), ('ME', 'مکانیک'), ('EL', 'برق'), ('OT', 'سایر')], max_length=2, verbose_name='رشته')),
            ...
            options={
                'verbose_name': 'historical ریز متره پروژه',
                'verbose_name_plural': 'historical ریز متره\u200cهای پروژه',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_list', models.ForeignKey(blank=True, db_constraint=False, help_text='فهرست بهایی که این صورت جلسه بر اساس آن است', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='fehrestbaha.pricelist', verbose_name='فهرست بها مرتبط')),
                ('project', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='project.project', verbose_name='پروژه مرتبط')),
            ],
            options={
                'verbose_name': 'historical صورت جلسه',
                'verbose_name_plural': 'historical صورت جلسات',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_list', models.ForeignKey(help_text='فهرست بهایی که این صورت جلسه بر اساس آن است', on_delete=django.db.models.deletion.PROTECT, related_name='measurement_sessions', to='fehrestbaha.pricelist', verbose_name='فهرست بها مرتبط')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('old_length', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='طول قبلی')),
                ('old_width', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='عرض قبلی')),
                ('old_height', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='ارتفاع قبلی')),
                ('old_count', models.DecimalField(decimal_places=2, default=1, max_digits=10, verbose_name='تعداد قبلی')),
                ('old_quantity', models.DecimalField(decimal_places=2, default=0, max_digits=15, verbose_name='مقدار قبلی')),
                ('revision_reason', models.TextField(blank=True, null=True, verbose_name='دلیل ویرایش')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('is_applied', models.BooleanField(default=False, verbose_name='اعمال شده')),
                ('edited_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='measurement_revisions', to=settings.AUTH_USER_MODEL, verbose_name='ویرایش\u200cکننده')),
                ('user_role', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='accounts.projectrole', verbose_name='نقش ویرایش\u200cکننده')),
                ('measurement_item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='revisions', to='sooratvaziat.measurementsessionitem', verbose_name='آیتم متره')),
            ],
            options={
                'verbose_name': 'نسخه متره',
                'verbose_name_plural': 'نسخه\u200cهای متره',
                'ordering': ['-created_at'],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='detailed_measurements', to='project.project', verbose_name='پروژه مرتبط')),
            ],
            options={
