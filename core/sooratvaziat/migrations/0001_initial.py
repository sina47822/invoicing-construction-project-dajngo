    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_date', models.DateField(help_text='تاریخ برگزاری صورت\u200cجلسه', verbose_name='تاریخ صورت\u200cجلسه')),
                ('discipline_choice', models.CharField(choices=[('AB', 'ابنیه'), ('ME', 'مکانیک'), ('EL', 'برق'), ('OT', 'سایر')], help_text='نوع فهرست بها (ابنیه، مکانیک، برق، ...)', max_length=2, verbose_name='رشته فعالیت')),
                ('description', models.TextField(blank=True, help_text='توضیحات اضافی صورت\u200cجلسه', null=True, verbose_name='توضیحات')),
                ('notes', models.TextField(blank=True, help_text='یادداشت\u200cهای داخلی', null=True, verbose_name='یادداشت\u200cها')),
                ('items_count', models.PositiveIntegerField(default=0, help_text='تعداد کل آیتم\u200cهای این صورت\u200cجلسه', verbose_name='تعداد آیتم\u200cها')),
                ('status', models.CharField(choices=[('draft', 'پیش\u200cنویس'), ('submitted', 'ارسال\u200cشده'), ('approved', 'تایید\u200cشده'), ('rejected', 'رد\u200cشده')], default='draft', max_length=20, verbose_name='وضعیت')),
